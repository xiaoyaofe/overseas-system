    ...
    <div>
        ...
        <div class="content">
            <section v-for="(item,i) in feepBackData" :key="i">
                ...
                <div>
                    <h5 class="cSolve">解决方法:&nbsp;{{item.solve}}</h5>
...
export default {
    data () {
        return {
            ...
            feepBackData:[
                {
                    description:'渠道包配置数据异常',
                    solve:'如果投放新包没数据或者数据翻倍，大概率配置错误或者重复配置',
                    imageUrl:require('../images/tf_1.png') ,
                    isButton:false,
                },{
                    description:'激活注册创角少量异常：',
                    solve:'重算当日数据',
                    imageUrl:require('../images/tf_2.png'), 
                    isButton:false,
                },{
                    description:'充值花费少量异常：',
                    solve:'重算当日数据',
                    imageUrl:require('../images/tf_3.png'),
                    isButton:false,
                }
            ]
        }
